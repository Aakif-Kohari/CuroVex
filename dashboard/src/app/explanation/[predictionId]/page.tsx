...
export default function ExplanationPage() {
  ...
  const activeExplanation: Explanation | undefined =
    explanationData?.explanations?.find((e) => e.method === activeMethod);

  const otherExplanation: Explanation | undefined =
    explanationData?.explanations?.find((e) => e.method !== activeMethod);
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      >
        ...
        <p className="text-slate-400 text-sm">
          Compare path-based and counterfactual explanations for this
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-navy-800/50 border border-navy-700 rounded-2xl p-6">
              ...
              {activeMethod === "counterfactual" &&
                activeExplanation.subgraph.masked_edges && (
                  <div className="space-y-2">
                    <h4 className="text-sm font-medium text-slate-300 mb-2">
                      Top Impact Edges (
                      {activeExplanation.subgraph.masked_edges.length} analyzed)
                    </h4>
