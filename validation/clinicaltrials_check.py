...
def check_clinical_trials(drug_name: str, disease_name: str) -> ClinicalTrialResult:
    ...
    evidence_url = (
        f"https://clinicaltrials.gov/search?intr={enc_drug}&cond={enc_disease}"
    )

    url = f"{base_url}/studies"
    params = {"query.intr": drug_name, "query.cond": disease_name, "pageSize": 5}
    ...
    try:
        ...
        return ClinicalTrialResult(
            has_trial=False, trial_count=0, trials=[], evidence_url=evidence_url
        )
